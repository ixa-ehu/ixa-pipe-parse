...
import es.ehu.si.ixa.ixa.pipe.heads.CollinsHeadFinder;
import es.ehu.si.ixa.ixa.pipe.heads.HeadFinder;
...
public class CLI {
	...
	/**
	   ...
	   * file.
	   */
	  private final static String commit = CLI.class.getPackage().getSpecificationVersion();
  ...
  public static void main(String[] args) throws IOException, JDOMException {
    ...
    ArgumentParser parser = ArgumentParsers.newArgumentParser(
        ...
        "ixa-pipe-parse-" + version + " is a multilingual constituent parser "
    ...
    try {
      ...
      System.out
          .println("Run java -jar target/ixa-pipe-parse-" + version + ".jar -help for details");
      System.exit(1);
    }
    ...
    try {
      ...
      kaf.addLinguisticProcessor("constituency", "ixa-pipe-parse-" + Files.getNameWithoutExtension("model"), version + "-" + commit);
